...
<button onclick="openModal()">모달 열기</button>
	...
	<div>
		...
		<input type="hidden" id="authMobile" /> <input type="hidden"
			id="authEmail" /> <input type="hidden" id="emailCode" /> <input
			type="hidden" id="uid" value="${sessionScope.account.uid}" />
		...
		<div>
			...
			<div id="startEmailVerifiTap">
				...
				<button type="button" id="changeEmailStartVerifiBtn">인증번호
					발송</button>
			</div>
