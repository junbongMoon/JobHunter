        ...
        <div id="userModifyTab">
          <div class="info-section">
            ...
            <div class="info-grid">
              ...
              <div>나이</div>
              <div><input type="text" class="form-control" placeholder="나이를 입력하세요"></div>
              
              <div>병역사항</div>
              <div>
                <select class="form-control">
                  <option value="">선택하세요</option>
                  <option value="NOT_COMPLETED">미필</option>
              ...
              <div>
                <select class="form-control" id="payType">
                  ...
                  <option value="COMPANY">회사 내규에 따름</option>
                </select>
              </div>
              
              <div>희망급여</div>
              <div><input type="text" class="form-control" id="pay" placeholder="희망급여를 입력하세요"></div>
            </div>
          </div>
...
<script>
  ...
  function updateUserModyfyTab(userInfo) {
    const userModyfyTab = document.getElementById('userModifyTab');
  ...
  $(()=>{
    ...
    $(document).on('click', '#chanegeDetailInfoBtn', ()=>{
      ...
      // 트릭: 잠깐 기다렸다가 클래스를 추가해야 트랜지션이 작동함
      setTimeout(() => {
  ...
  function setSearchAddressOption(jsonStr) {
    ...
    jsonStr.results.juso.forEach(item => {
      ...
      li.addEventListener('click', function() {
        ...
        // 검색창에 선택된 주소 표시
        addressSearch.value = this.dataset.value;
