<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
      ...
      <section data-aos="fade-up" data-aos-delay="100" class="spacerContainer">
        ...
        <div class="spacer">
              ...
              <section data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="info-grid" id="userDetailInfo">
                  ...
                  <div class="introduce-section">
                    <div class="introduce-title">자기소개</div>
                    <div class="introduce-content">로딩중...</div>
                  </div>
                  <div class="edit-buttons">
                    <button class="btn-edit" onclick="modyfiInfoTapOpen()"><i class="bi bi-pencil-square"></i> 상세정보
                      수정</button>

                    <button id="accountDeleteBtn" class="btn-edit btn-delete"
                      style="background-color:#dc3545; margin-left: auto;" onclick="deleteAccount()"> 계정 삭제 신청</button>
                  </div>
                </div>
              </section>
                ...
                <div id="userModifyTab">
                  <div class="info-section">
                    ...
                    <div class="info-grid">
                      ...
                      <div id="payDiv" style="display: none;"><input type="text" class="form-control" id="pay"
                          placeholder="희망급여를 입력하세요"></div>
                    </div>
                  </div>
                  <div class="introduce-section">
              ...
              <section data-aos="fade-up" data-aos-delay="300">
                <div class="section-title">
                  <h2 onclick="toggleResumeSectionItems()" style="cursor: pointer;"><i
                      class="bi bi-heart section-icon"></i>신청한 이력서<span style="font-size:0.7em"> ▼ </span></h2>
                  <span class="resumeSectionItems" style="display:none;"><button class="btn-edit"
                      onclick="resumeReadOnly()" id="resumeReadOnlyBtn">조회된 신청서만 검색</button></span>
                  <span class="resumeSectionItems" style="display:none; float:right"><button class="btn-edit"
                      onclick="resumeSortOption()" id="resumeSortOptionBtn">최신순으로 정렬</button></span>
              ...
              <section data-aos="fade-up" data-aos-delay="400">
                <div class="section-title">
                  <h2 onclick="toggleReviewSectionItems()" style="cursor: pointer;"><i
                      class="bi bi-heart section-icon"></i>작성한 리뷰<span style="font-size:0.7em"> ▼ </span></h2>
                  <button class="btn-edit reviewSectionItems" style="display:none;" onclick="openReviewSearchModal()">리뷰
                    검색 옵션</button>
                </div>
              ...
              <section data-aos="fade-up" data-aos-delay="400">
                <div class="section-title">
                  <h2 onclick="toggleResumeAdviceSectionItems()" style="cursor: pointer;"><i
                      class="bi bi-heart section-icon"></i>답변받은 이력서 첨삭<span style="font-size:0.7em"> ▼ </span></h2>
                </div>
              ...
              <c:if test="${account.isMentor == 'Y'}">
                ...
                <section data-aos="fade-up" data-aos-delay="400">
                  <div class="section-title">
                    <h2 onclick="togglePrboardSectionItems()" style="cursor: pointer;"><i
                        class="bi bi-heart section-icon"></i>등록한 멘토pr글<span style="font-size:0.7em"> ▼ </span></h2>
                  </div>
              ...
              <section data-aos="fade-up" data-aos-delay="400">
                <div class="section-title">
                  <h2 onclick="toggleRegistrationAdviceSectionItems()" style="cursor: pointer;"><i
                      class="bi bi-heart section-icon"></i>첨삭 요청<span style="font-size:0.7em"> ▼ </span></h2>
  ...
  `
          ...
          function acceptAdviceModal(resumeNo, menteeUid) {
            window.publicModals.show("첨삭을 승인하시겠습니까?", {
              cancelText: "취소", onConfirm: () => {
                $.ajax({
          ...
          function rejectAdviceModal(resumeNo, userUid) {
            window.publicModals.show("첨삭을 거절하시겠습니까?", {
              cancelText: "취소", onConfirm: () => {
                $.ajax({
