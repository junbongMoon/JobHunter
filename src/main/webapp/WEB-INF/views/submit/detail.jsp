			...
			<body>
				...
				<form onsubmit="return false;">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<div class="row g-3">
								<!-- 증명사진 업로드 -->
								<div class="col-md-2">
									<div class="d-flex justify-content-center align-items-center border rounded position-relative photoUploadBox" style="height: 200px; background-color: #f8f9fa;">
										<c:choose>
										    <c:when test="${not empty submit.profileBase64}">
										        <img id="photoPreview" src="${submit.profileBase64}" alt="사진 미리보기" style="max-height: 100%; max-width: 100%;">
										    </c:when>
										    <c:otherwise>
										        <span>증명사진 없음</span>
										    </c:otherwise>
								...
								<div class="col-md-9 pContent">
									<div class="row g-3">
										<div class="col-md-4">
											...
											<input type="text" class="form-control" value="${submit.userName}" readonly>
										</div>
										<div class="col-md-4">
											<label class="form-label">나이</label>
											<c:choose>
											    <c:when test="${not empty submit.age}">
											        <input type="text" class="form-control" value="${submit.age}" readonly>
											    </c:when>
											    <c:otherwise>
											        <input type="text" class="form-control" value="나이 미공개" readonly>
											    </c:otherwise>
											</c:choose>
										</div>
										<div class="col-md-4">
											...
											<c:choose>
											    <c:when test="${not empty submit.gender}">
											        <input type="text" class="form-control" value="${submit.gender eq 'MALE' ? '남성':'여성'}" readonly>
											    </c:when>
											    <c:otherwise>
										...
										<div class="col-md-4">
											...
											<c:choose>
											    <c:when test="${not empty submit.email}">
											        <input type="email" class="form-control" value="${submit.email}" readonly>
											    </c:when>
											    <c:otherwise>
											        <input type="email" class="form-control" value="등록된 이메일 없음" readonly>
											    </c:otherwise>
											</c:choose>
										</div>
										<div class="col-md-4">
											...
											<c:choose>
											    <c:when test="${not empty submit.mobile}">
											        <input type="tel" class="form-control" value="${submit.mobile}" readonly>
											    </c:when>
											    <c:otherwise>
											        <input type="tel" class="form-control" value="등록된 전화번호 없음" readonly>
											    </c:otherwise>
											</c:choose>
										</div>
										<div class="col-md-4">
											...
											<c:choose>
											    <c:when test="${not empty submit.addr}">
											        <input type="text" class="form-control" value="${submit.addr}" readonly>
											    </c:when>
											    <c:otherwise>
											        <input type="text" class="form-control" value="등록된 거주지 없음" readonly>
											    </c:otherwise>
											</c:choose>
										</div>
									</div>
						...
						<div class="card-body">
							<div class="row g-3 align-items-center">
								...
								<div class="col-md-4 d-flex align-items-center">
									<input type="text" class="form-control text-end" value="${submit.pay}">
							...
							<div id="educationContainer">
								...
								<div class="education-item border rounded p-3 mb-3 position-relative">
									<div class="row g-3">
										<!-- 학력 레벨 선택 -->
										<div class="col-md-4">
											<label class="form-label">학력 구분</label>
											<select class="form-select education-level">
										...
										<!-- 학력 상태 선택 -->
										<div class="col-md-4">
											<label class="form-label">학력 상태</label>
											<select class="form-select education-status">
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control custom-input" value="${education.formattedGraduationDate}" readonly>
										</div>

										<!-- 학교명 입력 -->
										<div class="col-md-4">
											<label class="form-label">학교명</label>
											<input type="text" class="form-control custom-input" value="${education.customInput}" readonly>
										</div>
									</div>
								</div>
								...
								<div class="history-item border rounded p-3 mb-3 position-relative">
									<div class="row g-3">
										...
										<div class="col-md-6">
											...
											<input type="text" class="form-control company-name" value="${historie.companyName}" readonly>
										</div>

										<!-- 직위 입력 -->
										<div class="col-md-6">
											<label class="form-label">직위</label>
											<input type="text" class="form-control position" value="${historie.position}" readonly>
										</div>
										...
										<div class="col-md-6">
											...
											<div class="row g-3">
												<div class="col-md-5">
													<input type="text" class="form-control position" value="${historie.startDate}" readonly>
												</div>
												<div class="col-md-2 text-center d-flex align-items-center justify-content-center textflow">
													<span>~</span>
												</div>
												<div class="col-md-5">
													<input type="text" class="form-control position" value="${historie.endDate}" readonly>
												</div>
											</div>
										...
										<div class="col-md-12">
											...
											<input type="text" class="form-control job-description" value="${historie.jobDescription}" readonly>
										</div>
									</div>
								</div>
									...
									<div class="license-item border rounded p-3 mb-3 position-relative">
										...
										<div class="row g-3">
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control license-name" value="${license.licenseName}" readonly>
											</div>
											<!-- 발급기관 입력 -->
											<div class="col-md-6">
												<label class="form-label">발급기관</label>
												<input type="text" class="form-control institution" value="${license.institution}" readonly>
											</div>
											<!-- 취득날짜 -->
											<div class="col-md-4">
												<label class="form-label">취득날짜</label>
												<input type="text" class="form-control institution" value="${license.formattedAcquisitionDate}" readonly>
											</div>
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<textarea class="form-control" id="selfIntroTextarea" rows="8" readonly>
								${submit.introduce}
							</textarea>
						</div>
					</div>
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<div id="fileContainer" class="border rounded p-3">
								...
								<div class="text-center text-muted fileText" style="display: none;">
