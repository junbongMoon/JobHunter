									...
									<div class="d-flex flex-wrap">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox" name="jobForm"
												value="FULL_TIME" id="fullTime"> <label class="form-check-label"
												for="fullTime">정규직</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox" name="jobForm"
												value="CONTRACT" id="contract"> <label class="form-check-label"
												for="contract">계약직</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox" name="jobForm"
												value="DISPATCH" id="dispatch"> <label class="form-check-label"
												for="dispatch">파견직</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox" name="jobForm"
												value="PART_TIME" id="partTime"> <label class="form-check-label"
												for="partTime">아르바이트</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox" name="jobForm"
												value="COMMISSION" id="commission"> <label class="form-check-label"
												for="commission">위촉직</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox" name="jobForm"
												value="FREELANCE" id="freelance"> <label class="form-check-label"
												for="freelance">프리랜서</label>
										</div>
									</div>
								</div>
							</div>
					...
					<template id="educationTemplate">
						<div class="education-item border rounded p-3 mb-3 position-relative">
							...
							<div class="row g-3">
								...
								<!-- 졸업 상태 -->
								<div class="col-md-3">
									<label class="form-label">졸업 상태<span class="essentialPoint">*</span></label> <select
							...
							<div class="row g-3">
								...
								<div class="col-md-12">
									<label class="form-label">담당업무<span class="essentialPoint">*</span></label> <input
										type="text" class="form-control job-description" name="jobDescription"
										placeholder="담당업무를 입력하세요(최대 100자)" maxlength="100">
								</div>
							</div>
						</div>
					</template>
