...
@Component
public class CompanyAndAdminRoleInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        try {
            ...
            // 일단 진짜 본인만 체크하는거
            boolean isEqType = account.getAccountType() == AccountType.COMPANY;
            // 어드민 허용 페이지고 내가 어드민인지 체크
            boolean isAdminAllowed = account.getIsAdmin() == "Y";
