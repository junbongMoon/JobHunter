...
public class CompanyRestController {
	...
	public ResponseEntity<?> updateCompanyInfo(@RequestBody CompanyInfoDTO companyInfo, @PathVariable("uid") Integer uid,
			HttpSession session) {
	...
	public ResponseEntity<?> valiedBusiness(@RequestBody BusinessRequestDTO dto) {
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("사업자 진위 확인 중 오류 발생: " + e.getMessage());
		}
	}
